...
export default class Export extends SfCommand<ExportResult> {
  ...
  public async run(): Promise<any> {  
    ...
    this.describeMap = await this.makeDescribeMap(this.objects, this.connection, flags);
